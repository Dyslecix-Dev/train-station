...
import { createExercise } from "@/app/(protected)/exercises/actions";
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-lg">
        ...
        <form ref={formRef} id={form.id} onSubmit={form.onSubmit} action={formAction} className="flex flex-col gap-5 pt-2" encType="multipart/form-data">
          {form.errors && (
